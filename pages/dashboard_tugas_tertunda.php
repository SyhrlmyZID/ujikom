        ...
        <div style="position: relative; top: 8px;">
          <form method="GET">
            <input id="search-task" name="search" type="text" placeholder="Cari Tugas..."
              ...
              class="w-72 pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#344cb7] focus:border-[#344cb7] text-sm font-medium text-gray-700 transition-all"
              autocomplete="off" />
